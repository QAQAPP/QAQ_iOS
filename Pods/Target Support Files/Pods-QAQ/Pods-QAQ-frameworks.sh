...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/BlurImageProcessor/BlurImageProcessor.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/SCPageViewController/SCPageViewController.framework"
  install_framework "$BUILT_PRODUCTS_DIR/SCScrollView/SCScrollView.framework"
